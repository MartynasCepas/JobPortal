...
namespace JobPortal.Migrations
{
    ...
    [Migration("20211107232719_offer_user_link")]
    partial class offer_user_link
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPortal.Data.Dtos.Auth.User", b =>
                {
            ...
            modelBuilder.Entity("JobPortal.Data.Entities.Offer", b =>
                {
                    b.HasOne("JobPortal.Data.Dtos.Auth.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JobPortal.Data.Dtos.Auth.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
